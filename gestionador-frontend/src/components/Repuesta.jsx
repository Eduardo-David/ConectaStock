...
function Respuesta({ valido}) {
    if (valido === true) {
        return (
            <div
                role="alert"
                class="rounded-md border border-gray-300 bg-white p-4 shadow-sm dark:border-gray-600 dark:bg-gray-800"
            >
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <strong class="font-medium text-gray-900 dark:text-white"> Processo exitoso </strong>
                    </div>
        ...
        return (
            ...
            >
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        <strong class="font-medium text-gray-900 dark:text-white"> Proceso fallido </strong>
                    </div>
